...
| 标准参数名 | 别名 |
|-----------|------|
| origin | start, from, start_location, departure_location, pickup, leave_from |
| destination | end, to, end_location, target, target_location, place, location, city, where, arrive_at, arrival_location |
| departure_time | date, time, departure_date, when, leave_time, start_time |
| preferred_mode | mode, preference, preferred_transport, transport, transport_type |
