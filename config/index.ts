...
export default defineConfig<'vite'>(async (merge, _env) => {
  ...
  const baseConfig: UserConfigExport<'vite'> = {
    ...
    copy: {
      patterns: [
        // 复制地图标记图标
        { from: 'src/assets/marker-start.png', to: 'dist-weapp/assets/marker-start.png' },
        { from: 'src/assets/marker-end.png', to: 'dist-weapp/assets/marker-end.png' },
        { from: 'src/assets/marker-start.png', to: 'dist-tt/assets/marker-start.png' },
        { from: 'src/assets/marker-end.png', to: 'dist-tt/assets/marker-end.png' },
      ],
      options: {},
    },
